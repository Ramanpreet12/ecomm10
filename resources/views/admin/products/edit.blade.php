                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                            ...
                                            <select class="form-control" name="family_color" style="width: 100%;">
                                                ...
                                                <option value="Red" @if (old('family_color', $product->family_color) === 'Red') selected @endif><b>Red</b></option>
                                                <option value="Blue"@if (old('family_color', $product->family_color) === 'Blue') selected @endif><b>Blue</b></option>
                                                <option value="Green" @if (old('family_color', $product->family_color) === 'Green') selected @endif><b>Green</b></option>
                                                <option value="Yellow" @if (old('family_color', $product->family_color) ==='Yellow' ) selected @endif><b>Yellow</b></option>
                                                <option value="Black" @if (old('family_color', $product->family_color) === 'Black') selected @endif><b>Black</b></option>
                                                <option value="Brown" @if (old('family_color', $product->family_color) === 'Brown') selected @endif><b>Brown</b></option>
                                                <option value="White" @if (old('family_color', $product->family_color) === 'White') selected @endif><b>White</b></option>
                                                <option value="Pink" @if (old('family_color', $product->family_color) ==='Pink') selected @endif><b>Pink</b></option>
                                                <option value="Grey" @if (old('family_color', $product->family_color) === 'Grey') selected @endif><b>Grey</b></option>
                                                <option value="Golden" @if (old('family_color', $product->family_color) === 'Golden') selected @endif><b>Golden</b></option>
                                                <option value="Silver" @if (old('family_color', $product->family_color) === 'Silver' ) selected @endif><b>Silver</b></option>
                                                <option value="Orange" @if (old('family_color', $product->family_color) === 'Orange') selected @endif><b>Orange</b></option>
                                            </select>
